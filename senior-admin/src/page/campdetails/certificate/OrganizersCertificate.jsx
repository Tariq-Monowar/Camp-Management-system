...
const OrganizersCertificate = () => {
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: "সংঠক সার্টিফিকেট তথ্য", 
      ...
      <div ref={componentRef} className="homePageContainer">
        <div style={{ marginBottom: "100px" }} className="regimentLest">
          <h1 className="regimentTitle">
            অংশগ্রহণকৃত সংঠক সংখ্যা: {allDeligatet?.length}
          </h1>
          <div className="downloadeShoit">
            <FaFilePdf className="pdfDownloade" onClick={handlePrint} />
            <DownloadTableExcel
              filename="সংঠক সার্টিফিকেট তথ্য"
              sheet="সংঠক সার্টিফিকেট তথ্য"
...
export default OrganizersCertificate;
