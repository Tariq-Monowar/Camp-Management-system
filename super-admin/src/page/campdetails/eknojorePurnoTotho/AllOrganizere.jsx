...
const AllOrganizere = () => {
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: "অংশগ্রহণকৃত সংঠক তথ্য", 
      ...
      <div ref={componentRef} className="homePageContainer">
        <div style={{ marginBottom: "100px" }} className="regimentLest">
          ...
          <div className="downloadeShoit">
            ...
            <DownloadTableExcel
              filename="অংশগ্রহণকৃত সকল সংগঠক তালিকা"
              sheet="অংশগ্রহণকৃত সকল সংগঠক তালিকা"
