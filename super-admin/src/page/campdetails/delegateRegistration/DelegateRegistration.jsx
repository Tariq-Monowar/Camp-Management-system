...
// import "./delegateRegistration.css";
...
//                 name=""
//                 id=""
//                 required={senOrganizationalvalues !== "প্রযোজ্য নয়"}
//                 disabled={senOrganizationalvalues === "প্রযোজ্য নয়"}
//               />
//             </div>
...
//                 disabled={organizationalvalues === "প্রযোজ্য নয়"}
//               />
//             </div>
...
//                   style={{ marginTop: "0px" }}
//                   className="deligetSubmitBtn"
//                   onClick={() => registerDelegated() && handleSubmit()}
//                   disabled={loading}
//                 >
//                   {loading ? (
//                     <Box
...
{
  /* <div style={{ textAlign: "center" }} className="againSelect">
<div className="popupSelection">
  <span>আপনার ক্যাটাগরি নির্বাচন করুন*</span>
  <br />
  <select
