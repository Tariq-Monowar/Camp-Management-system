...
const EknojoreRegimentInfo = () => {
  ...
  const mergedData = regimentData && regimentData.map((regiment) => {
    ...
    <>
      <div ref={componentRef} className="homePageContainer">
        <div className="regimentLest">
          <h1 className="regimentTitle">রেজিমেন্টের তথ্য</h1>
              ...
              mergedData?.map((reg, index) => (
                ...
                >
                  <tr>
                    ...
                    <td className="roomNumber">{reg.countTrue}</td>
                    {/* <td className="roomNumber">{reg.countFalse}</td> */}
                    <td className="actionud">
                      {console.log(reg.deligateCount)}
                      {/* {reg.deligateCount <= 0 ? ( */}
...
export default EknojoreRegimentInfo;
