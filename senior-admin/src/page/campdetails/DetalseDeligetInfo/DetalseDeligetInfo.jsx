        ...
        <div className="deligetAllData">
          ...
          <div className="detalseDev divleftdet">
            ...
            <div>
              ...
              <p>{delegateData.joiningDate && convertDateToBangla(delegateData.joiningDate)}</p>
            </div>
            <div>
              <span>
                {delegateData.organizationalvalues === "চৌকস"
              ...
              <>
                ...
                {delegateData.senOrganizationalvalues !== "প্রযোজ্য নয়" && (
                  <div>
                    ...
                    <p>{delegateData.senValueDate && convertDateToBangla(delegateData.senValueDate)}</p>
                  </div>
                )}
              </>
            )}
