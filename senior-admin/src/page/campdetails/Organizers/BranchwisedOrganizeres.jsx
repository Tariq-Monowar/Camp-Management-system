                      ...
                      {groupedObject[regiment].map(
                        (delegate, delegateIndex) => (
                          <tr key={delegateIndex}>
                            ...
                            <td>
                              <span onClick={()=>seeDetalseInfo(delegate.id)} style={{fontWeight: "normal"}} className="detalseInfo">
                                বিস্তারিত তথ্য
                              </span>
                            </td>
                          </tr>
...
export default BranchwisedOrganizeres;
