...
const DetalseDelegetCode = () => {
  const params = useParams();
  const campFirebase = UseCampFirebase();
  const [AllDelegetList, setAllDeligate] = useState([]);
    ...
    const getAllData = async () => {
      try {
        ...
        const filteredData = data.filter(
          (item) => item.brance.trim() === params.branceName.trim()
        );
                    ...
                    <div>
                      ...
                      {data.organizationalvalues !== "প্রযোজ্য নয়" && (
                        <p>
                          {data.organizationalvalues !== "প্রযোজ্য নয়"
                            ? data.organizationalvalues &&
                              convertDateToBangla(data.joiningDate)
                            : data.organizationalvalues}
                        </p>
                      )}
                    </div>
...
export default DetalseDelegetCode;
